\chapter{Linear Sentences In Two Variables}

\section{Linear Sentences In Two Variables}
You can solve two equations with the same variables by graphing, substitution, elimination, matrices, anddeterminants.

\subsection{Linear Equations: Solutions Using Graphing}
To solve by graphing, you plot both equations on a graph and see where they intersect.

\textbf{Example:} $4x + 3y = 6$ \& $2x - 5y = 16$
